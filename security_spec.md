...
2. `site_config` is publicly readable but only admin writable.
...
4. **Unauthorized Global Write**: Unauthenticated user trying to update `settings/site_config`.
...
| site_config| Protected | N/A | Protected |
